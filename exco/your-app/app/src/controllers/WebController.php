...
final class WebController extends BaseController
{
    ...
    //confirm_idcancellation
	public function confirm_idcancellation(Request $request, Response $response, $args)
    {
        $this->logger->info("confirm_idcancellation page action dispatched");

        //$this->flash->addMessage('info', 'change_idcancellation page load');

        $this->view->render($response, 'confirm-idcancellation.html');
        return $response;
    }
    //charts
