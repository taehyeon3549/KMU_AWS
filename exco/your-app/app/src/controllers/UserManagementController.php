...
// who : send to address,  code : certicate code,  client: web or app(where clicked),  type: 0=certification, 1=resetpassword
	public function send_mail($who, $code, $client, $type){
		...
		try{
			...
			$mail->SMTPAuth = true;
			$mail->Username = 'qi.tema.c@gmail.com';   //SMTP username
			$mail->Password = '!q1234567';
			$mail->SMTPSecure = 'tls';
			$mail->Port = 587;

			//Recipients
			$mail->setFrom('qi.tema.c@gmail.com', "teamciot");
			$mail->addAddress($who);
			$mail->isHTML(true);
			...
			if($type == 0){
				...
				<table align="center" border="0" cellpadding="0" cellspacing="0" width="600">
					<tr>
						<td align="center" bgcolor="#01dea5" style="padding: 40px 0 30px 0;">
							<img src= "http://13.125.112.70/mail_iconn.png" alt="Thank you for certification!!" height="230" style="display: block;width: 100%"/>
						</td>
					</tr>
					<tr>
						<td bgcolor="#f8f9fa" style="padding: 40px 30px 40px 30px;">
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr align="center" style="height: 200px;">
									<td>
										<h2><b><a href = http://13.125.112.70/verify/'.$client.'/'.$code.'>http://13.125.112.70/verify/'.$client.'/'.$code.'</a></b></h2>
									</td>
								</tr>
								<tr>
									<td>
				...
				<table align="center" border="0" cellpadding="0" cellspacing="0" width="600">
					<tr>
						<td align="center" bgcolor="#01dea5" style="padding: 40px 0 30px 0;">
							<img src= "http://13.125.112.70/mail_iconn.png" alt="Change your password" height="230" style="display: block;width: 100%"/>
						</td>
					</tr>
					<tr>
						<td bgcolor="#f8f9fa" style="padding: 40px 30px 40px 30px;">
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr align="center" style="height: 200px;">
									<td>
										<h2><b><a href = http://13.125.112.70/pass/'.$code.'>http://13.125.112.70/pass/'.$code.'</a></b></h2>
									</td>
								</tr>
								<tr>
									<td>
